...
void main() {
  ...
  vec3 lightCol = vec3(0.34, 0.46, 0.60);          // cool steel-blue beam (dimmer)
  color += light * (0.10 + 0.30 * f) * lightCol;   // volumetric: brighter where mist is thick

  // gentle center lift
  color += smoothstep(0.9, 0.1, length(uvr - 0.5)) * 0.025 * u_accent;
